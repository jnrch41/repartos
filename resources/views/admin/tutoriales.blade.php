    ...
    <div class="row">
          <div class="col-md-4">
              <div class="card">
                  <iframe width="100%" height="315" src="https://www.youtube.com/embed/uBDJplLmSVw?rel=0&amp;showinfo=0" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
                  <div class="card-body">
                      <h4 class="tutoriales_card_titulo">Usuarios</h4>
                      <p class="tutoriales_descripcion">Explica como crear, editar o eliminar usuarios, asignarles un perfil y cambiarlo.</p>
                  </div>
              </div>
          </div>
          <div class="col-md-4">
              <div class="card">
                  <iframe width="100%" height="315" src="https://www.youtube.com/embed/uBDJplLmSVw?rel=0&amp;showinfo=0" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
                  <div class="card-body">
                      <h4 class="tutoriales_card_titulo">Estadísticas</h4>
                      <p class="tutoriales_descripcion">Explica como trabajar con el sistema de estadísticas</p>
                  </div>
              </div>
          </div>
  	</div>
